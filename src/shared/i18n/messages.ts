...
const en = {
  ...
  'toast.installed': 'Skill {name} installed / updated: {version}',
  'toast.installedGeneric': 'Skill {name} installed / updated',
  ...
  'settings.cliPathPlaceholder': 'Path to skills binary (optional)',
  'settings.npmRegistryPlaceholder': 'npm registry (optional)',
  'settings.proxyPlaceholder': 'Proxy (optional)',
...
const ru: Record<keyof typeof en, string> = {
  ...
  'toast.installed': 'Skill {name} установлен / обновлен: {version}',
  'toast.installedGeneric': 'Skill {name} установлен / обновлен',
  ...
  'detail.checkedOn': 'Проверено: {date}',
  ...
  'settings.cliPathPlaceholder': 'Путь к бинарю skills (необязательно)',
  'settings.npmRegistryPlaceholder': 'npm registry (необязательно)',
  'settings.proxyPlaceholder': 'Прокси (необязательно)',
