...
const en = {
  ...
  'catalog.updateAll': 'Update all',
  'catalog.updateAllTitle': 'Update all skills with an available update',
  'catalog.refresh': 'Check for updates',
  'catalog.refreshTitle': 'Reinitialize the list and check versions (as on startup)',
  ...
  'jobs.expand': 'Expand events',
  'jobs.collapse': 'Collapse events',
  'jobs.hasErrors': 'There are errors',
  'jobs.noEvents': 'No events',
...
const ru: Record<keyof typeof en, string> = {
  ...
  'catalog.updateAll': 'Обновить все',
  'catalog.updateAllTitle': 'Обновить все skills с доступным обновлением',
  'catalog.refresh': 'Проверить обновления',
  'catalog.refreshTitle': 'Переинициализировать список и проверить версии (как при запуске)',
  ...
  'jobs.expand': 'Развернуть события',
  'jobs.collapse': 'Свернуть события',
  'jobs.hasErrors': 'Есть ошибки',
  'jobs.noEvents': 'Событий нет',
