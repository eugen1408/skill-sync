...
const en = {
  ...
  'jobs.update.checkedCount': 'Checked {count}',
  'jobs.update.autoCompleted': 'Auto-update completed',
  'jobs.update.autoResult': 'Updated: {ok}. Errors: {failed}.',
  'jobs.update.autoSkippedRisk': ' Skipped due to risk (Medium+): {names}.',
  'jobs.update.autoSkipped': 'Auto-update skipped',
  'jobs.update.autoSkippedMsg': 'Updates are available but were skipped due to risk: {names}.',
  'jobs.update.newVersionTitle': 'New version available',
  'jobs.update.runProgress': 'Updated {done}/{total}',
  'jobs.update.errorTitle': 'Update error',
  'jobs.update.errorMsg': 'Failed to update {name}',
  'jobs.update.successTitle': 'Update installed',
  'jobs.update.successMsg': '{name} updated',
...
const ru: Record<keyof typeof en, string> = {
  ...
  'jobs.update.checkedCount': 'Проверено {count}',
  'jobs.update.autoCompleted': 'Автообновление завершено',
  'jobs.update.autoResult': 'Обновлено: {ok}. Ошибок: {failed}.',
  'jobs.update.autoSkippedRisk': ' Пропущено из-за риска (Medium+): {names}.',
  'jobs.update.autoSkipped': 'Автообновление пропущено',
  'jobs.update.autoSkippedMsg': 'Доступны обновления, но пропущены из-за риска: {names}.',
  'jobs.update.newVersionTitle': 'Доступна новая версия',
  'jobs.update.runProgress': 'Обновлено {done}/{total}',
  'jobs.update.errorTitle': 'Ошибка обновления',
  'jobs.update.errorMsg': 'Не удалось обновить {name}',
  'jobs.update.successTitle': 'Обновление установлено',
  'jobs.update.successMsg': '{name} обновлён',
